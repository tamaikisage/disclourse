(ns com.github.tamaikisage.disclourse
  (:require [com.biffweb :as biff]
            [com.github.tamaikisage.disclourse.email :as email]
            [com.github.tamaikisage.disclourse.app :as app]
...
(defn on-save [ctx]
  ...
  (biff/eval-files! ctx)
  (generate-assets! ctx)
  (test/run-all-tests #"com.github.tamaikisage.disclourse.*-test"))
...
(def initial-system
  {:biff/modules #'modules
   ...
   :com.github.tamaikisage.disclourse/chat-clients (atom #{})})
