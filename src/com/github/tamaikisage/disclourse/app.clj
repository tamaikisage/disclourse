(ns com.github.tamaikisage.disclourse.app
  (:require [com.biffweb :as biff :refer [q]]
            ...
            [com.github.tamaikisage.disclourse.settings :as settings]
            [rum.core :as rum]
            [xtdb.api :as xt]
...
(defn notify-clients [{:keys [com.github.tamaikisage.disclourse/chat-clients]} tx]
...
(defn ws-handler [{:keys [com.github.tamaikisage.disclourse/chat-clients] :as ctx}]
  {:status 101
